					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								...
								$db = new DB();
								$UpID = $_GET["update_ID"];
								$product = $db->getProduct($UpID);
								?>
								<form action="index.php?id=<?php echo $UpID?>" method="post" class="form-horizontal" enctype="multipart/form-data">
									<div class="control-group">
										<label class="control-label">Name :</label>
										<div class="controls">
											<input type="text" class="span11" placeholder="Product name" name="name1" value="<?php echo $product[0]["name"]?>" /> *
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<select name="type_id1">
												...
												{
													if($product[0]['type_name'] == $value["type_name"])
													{
														?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="manu_id1">
												<?php 
												$manu = $db->getManu();
												foreach($manu as $value)
												{
													if($product[0]['manu_name'] == $value["manu_name"])
													{
														?>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<img src="public/images/<?php echo $product[0]["image"]?>" width="100px" height="100px">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label"  >Description</label>
											<div class="controls">
												<textarea class="span11" placeholder="Description" name = "description1" value = ""><?php echo $product[0]["description"]?></textarea>
											</div>
											<div class="control-group">
												<label class="control-label">Price :</label>
												<div class="controls">
													<input type="text" class="span11" placeholder="price" name = "price1" value="<?php echo $product[0]["price"]?>" /> *
												</div>
